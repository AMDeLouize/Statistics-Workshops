...
First, attach the packages you need. If you need to install the packages, delete the hashtag then run the install packages command. As a reminder you can run code by pusing RUN at the top of the document, by pushing on the green triangle, or by pushing ctrl + enter. 
```{r}
...
First, create a new project by entering the "File" menu. The name and location of your project will be the name and location of a new folder on your computer. Save this document in that new folder. You will save the data in this folder as well.  
